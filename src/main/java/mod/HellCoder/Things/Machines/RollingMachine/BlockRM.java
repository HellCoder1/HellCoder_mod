...
public class BlockRM extends BlockContainer {

    public BlockRM(Material materialIn, String name) {
        super(materialIn);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        //playerIn.openGui(HellCoder_mod.instance, GuiHandlerRM.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        playerIn.openGui(HellCoder_mod.instance, GuiHandlerRM.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
